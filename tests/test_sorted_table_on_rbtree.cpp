...
TEST(TestSortedTableOnRBTree, default_constructor) {
	// Arrange
	SortedTableOnRBTree<int, int> table;
...
TEST(TestSortedTableOnRBTree, insert_one_element) {
	// Arrange
	SortedTableOnRBTree<int, int> table;
...
TEST(TestSortedTableOnRBTree, insert_several_elements) {
	// Arrange
	SortedTableOnRBTree<int, int> table;
...
TEST(TestSortedTableOnRBTree, insert_duplicate_key) {
	// Arrange
	SortedTableOnRBTree<int, int> table;
	table.insert(5, 50);
...
TEST(TestSortedTableOnRBTree, insert_after_LL_rotation) {
	// Arrange
	SortedTableOnRBTree<int, int> table;
...
TEST(TestSortedTableOnRBTree, insert_after_RR_rotation) {
	// Arrange
	SortedTableOnRBTree<int, int> table;
...
TEST(TestSortedTableOnRBTree, insert_after_LR_rotation) {
	// Arrange
	SortedTableOnRBTree<int, int> table;
...
TEST(TestSortedTableOnRBTree, insert_after_RL_rotation) {
	// Arrange
	SortedTableOnRBTree<int, int> table;
...
TEST(TestSortedTableOnRBTree, insert_recolor_case) {
	// Arrange
	SortedTableOnRBTree<int, int> table;
	...
	EXPECT_EQ(100, *table.found(10));
	EXPECT_EQ(50, *table.found(5));
	EXPECT_EQ(150, *table.found(15));
	EXPECT_EQ(30, *table.found(3));
}

TEST(TestSortedTableOnRBTree, found_in_empty_table) {
	// Arrange
	SortedTableOnRBTree<int, int> table;
...
TEST(TestSortedTableOnRBTree, found_exist_key) {
	// Arrange
	SortedTableOnRBTree<int, int> table;
	table.insert(5, 50);
	table.insert(3, 30);
...
TEST(TestSortedTableOnRBTree, found_root_key) {
	// Arrange
	SortedTableOnRBTree<int, int> table;
	table.insert(5, 50);
...
TEST(TestSortedTableOnRBTree, found_not_exist_key) {
	// Arrange
	SortedTableOnRBTree<int, int> table;
	table.insert(5, 50);
	table.insert(3, 30);
...
TEST(TestSortedTableOnRBTree, erase_from_empty_table) {
	// Arrange
	SortedTableOnRBTree<int, int> table;
...
TEST(TestSortedTableOnRBTree, erase_not_exist_key) {
	// Arrange
	SortedTableOnRBTree<int, int> table;
	table.insert(5, 50);
	table.insert(3, 30);
...
TEST(TestSortedTableOnRBTree, erase_only_one_element) {
	// Arrange
	SortedTableOnRBTree<int, int> table;
	table.insert(5, 50);
...
TEST(TestSortedTableOnRBTree, erase_left_leaf) {
	// Arrange
	SortedTableOnRBTree<int, int> table;
	table.insert(20, 200);
	table.insert(10, 100);
...
TEST(TestSortedTableOnRBTree, erase_right_leaf) {
	// Arrange
	SortedTableOnRBTree<int, int> table;
	table.insert(20, 200);
	table.insert(10, 100);
...
TEST(TestSortedTableOnRBTree, erase_node_with_only_left_child) {
	// Arrange
	SortedTableOnRBTree<int, int> table;
	table.insert(20, 200);
	table.insert(10, 100);
...
TEST(TestSortedTableOnRBTree, erase_node_with_only_right_child) {
	// Arrange
	SortedTableOnRBTree<int, int> table;
	table.insert(20, 200);
	table.insert(10, 100);
...
TEST(TestSortedTableOnRBTree, erase_node_with_two_children) {
	// Arrange
	SortedTableOnRBTree<int, int> table;
	table.insert(50, 500);
	table.insert(30, 300);
...
TEST(TestSortedTableOnRBTree, erase_root_with_two_children) {
	// Arrange
	SortedTableOnRBTree<int, int> table;
	table.insert(20, 200);
	table.insert(10, 100);
...
TEST(TestSortedTableOnRBTree, erase_many_elements) {
	// Arrange
	SortedTableOnRBTree<int, int> table;
...
TEST(TestSortedTableOnRBTree, check_is_empty_return_true) {
	// Arrange
	SortedTableOnRBTree<int, int> table;
...
TEST(TestSortedTableOnRBTree, check_is_empty_return_false) {
	// Arrange
	SortedTableOnRBTree<int, int> table;
...
TEST(TestSortedTableOnRBTree, check_is_empty_after_erase_all_elements) {
	// Arrange
	SortedTableOnRBTree<int, int> table;
	table.insert(1, 10);
	table.insert(2, 20);
...
TEST(TestSortedTableOnRBTree, big_table_insert_and_found_all_elements) {
	// Arrange
	SortedTableOnRBTree<int, int> table;
	int keys[31] = {
...
TEST(TestSortedTableOnRBTree, big_table_erase_many_different_cases) {
	// Arrange
	SortedTableOnRBTree<int, int> table;
	int keys[31] = {
	 50, 25, 75, 10, 30, 60, 90,
...
TEST(TestSortedTableOnRBTree, print_empty_table) {
	// Arrange
	SortedTableOnRBTree<int, int> table;
...
TEST(TestSortedTableOnRBTree, print_not_empty_table) {
	// Arrange
	SortedTableOnRBTree<int, int> table;
	std::ostringstream out;
...
TEST(TestSortedTableOnRBTree, print_after_erase) {
	// Arrange
	SortedTableOnRBTree<int, int> table;
	std::ostringstream out;
	table.insert(5, 50);
...
TEST(TestSortedTableOnRBTree, check_print_table) {
	// Arrange
	SortedTableOnRBTree<int, int> table;
